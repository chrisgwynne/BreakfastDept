...
<section class="section">
  <div class="container container--prose" style="text-align:center">
    ...
    <?php $ref = get('ref'); if ($ref): ?><p class="form-status" style="margin-top:var(--s-8);display:inline-block"><?= esc(t('breakfast.reference', 'Your reference')) ?>: <strong><?= esc($ref) ?></strong></p><?php endif ?>
