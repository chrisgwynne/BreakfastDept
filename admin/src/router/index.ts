...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'portfolio', name: 'portfolio', component: () => import('@/views/PortfolioView.vue'), meta: { perm: 'portfolio.view' } },
      { path: 'portfolio/homepage', name: 'portfolio-homepage', component: () => import('@/views/PortfolioHomepageView.vue'), meta: { perm: 'portfolio.homepage' } },
      { path: 'portfolio/:id', name: 'portfolio-record', component: () => import('@/views/PortfolioDetailView.vue'), meta: { perm: 'portfolio.view' } },
